package com.xiazhou.base.memcached.annotation;
...
public class CacheKeyUtils {
	 ...
	 * @return
	 */
	public static String buildCacheKey(String[] keys, Class<?> targetClz,
			Object[] args) {
		String argsKey = "";
		if (args != null) {
		...
		String wholeKey = StringUtils.join(new String[] {targetClz.getName() , argsKey }, UNDER_LINE);
